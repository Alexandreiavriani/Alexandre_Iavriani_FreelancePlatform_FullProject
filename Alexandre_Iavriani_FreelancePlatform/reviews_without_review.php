...
?>
 ...
 ?>
    				...
    				<div class="col-sm-4 text-center">
                        ...
                        $select_freelancer=mysqli_query($conn,"SELECT * FROM `freelancers` WHERE user_id=$freelancer_id");

                        while($row_freelancer = $select_freelancer->fetch_assoc()){
                            
                            echo '<p style="text-align: left;font-family: ArchyEDT-Bold, sans-serif; font-weight:bold;">'.$row_freelancer['about_me'].'</p>';
